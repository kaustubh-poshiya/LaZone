...
export default function Footer() {
  return (
    <footer className="bg-architect-navy text-white">
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        <ScrollReveal animation="fade-bottom">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            <div className="md:col-span-1">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  className="text-white/70 hover:text-architect-vibrant transition-colors"
            ...
            <div>
              <h3 className="text-sm font-medium uppercase tracking-wider mb-4 text-architect-vibrant">
                <Link
                  href="/services"
                  className="text-white/70 hover:text-architect-vibrant transition-colors text-sm flex items-center group"
                >
                  Services
                </Link>
              </h3>
            ...
            <div>
              <h3 className="text-sm font-medium uppercase tracking-wider mb-4 text-architect-vibrant">Company</h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/about"
            ...
            <div>
              <h3 className="text-sm font-medium uppercase tracking-wider mb-4 text-architect-vibrant">Contact</h3>
              <address className="not-italic text-white/70 text-sm space-y-2">
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <p>
                    <a href="mailto:contact@lazone.ae" className="hover:text-architect-vibrant transition-colors">
                      contact@lazone.ae
                    </a>
                  </p>
                </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="#" className="text-white/50 hover:text-architect-vibrant transition-colors text-xs">
              Privacy Policy
            </Link>
            <Link href="#" className="text-white/50 hover:text-architect-vibrant transition-colors text-xs">
              Terms of Service
