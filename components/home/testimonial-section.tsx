        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="relative w-14 h-14 rounded-full overflow-hidden flex-shrink-0 bg-gradient-to-br from-lazone-orange/20 to-lazone-orange/10 dark:from-lazone-orange/30 dark:to-lazone-orange/20 flex items-center justify-center border-2 border-lazone-orange/20">
                  <span className="text-xl font-semibold text-lazone-orange">{testimonials[0].name.charAt(0)}</span>
                </div>
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white text-lg">{testimonials[0].name}</h4>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2">
                    {testimonials[0].position}, <span className="text-lazone-orange font-medium">{testimonials[0].company}</span>
                  </p>
                  <div className="flex gap-1">{renderStars(testimonials[0].rating)}</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                <div className="relative w-11 h-11 rounded-full overflow-hidden flex-shrink-0 bg-gradient-to-br from-lazone-orange/20 to-lazone-orange/10 flex items-center justify-center border-2 border-lazone-orange/20">
                  <span className="text-base font-semibold text-lazone-orange">{testimonials[3].name.charAt(0)}</span>
                </div>
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white text-base">{testimonials[3].name}</h4>
                  <p className="text-xs text-neutral-600 dark:text-neutral-400 mb-1">
                    {testimonials[3].position}, <span className="text-lazone-orange font-medium">{testimonials[3].company}</span>
                  </p>
                  <div className="flex gap-0.5">{renderStars(testimonials[3].rating)}</div>
                </div>
              </div>
              <p className="text-neutral-700 dark:text-neutral-300 text-sm leading-relaxed">
                {testimonials[3].text}
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                <div className="relative w-11 h-11 rounded-full overflow-hidden flex-shrink-0 bg-gradient-to-br from-lazone-orange/20 to-lazone-orange/10 flex items-center justify-center border-2 border-lazone-orange/20">
                  <span className="text-base font-semibold text-lazone-orange">{testimonials[4].name.charAt(0)}</span>
                </div>
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white text-base">{testimonials[4].name}</h4>
                  <p className="text-xs text-neutral-600 dark:text-neutral-400 mb-1">
                    {testimonials[4].position}, <span className="text-lazone-orange font-medium">{testimonials[4].company}</span>
                  </p>
                  <div className="flex gap-0.5">{renderStars(testimonials[4].rating)}</div>
                </div>
              </div>
              <p className="text-neutral-700 dark:text-neutral-300 text-sm leading-relaxed">
                {testimonials[4].text}
