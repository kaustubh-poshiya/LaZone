    ...
    <section className="py-16 md:py-24 lg:py-32 bg-muted/30">
      <div className="container mx-auto px-4 md:px-6">
          ...
          {services.map((service, index) => (
            <ScrollReveal key={index} animation="fade-zoom" delay={index * 100}>
              <div className="group">
                ...
                <Link
                  href={service.link}
                  className="inline-flex items-center text-architect-vibrant hover:text-architect-vibrant/80 transition-colors"
                >
                  Explore
        ...
        <div className="text-center mt-12">
          <Link
            href="/services"
            className="inline-block px-8 py-3 border border-architect-vibrant text-architect-vibrant hover:bg-architect-vibrant hover:text-white transition-colors rounded-md"
          >
            View All Services
          </Link>
        </div>
