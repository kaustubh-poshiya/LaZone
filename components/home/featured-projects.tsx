      ...
      <div className="container mx-auto px-4 md:px-6">
        <ScrollReveal animation="fade-bottom">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            ...
            <Link
              href="/portfolio"
              className="mt-4 md:mt-0 inline-flex items-center border-b border-architect-vibrant pb-1 text-black hover:text-architect-vibrant transition-colors text-base md:text-lg"
            >
              View all projects
            </Link>
          </div>
        ...
        <div className="relative" ref={sliderRef}>
          ...
          <div className="absolute top-1/2 left-0 right-0 flex justify-between px-4 md:px-8 -mt-6 z-20">
            <Button
              ...
              size="icon"
              variant="outline"
              className="border-white text-black hover:bg-transparent hover:border-architect-vibrant rounded-full p-2 h-12 w-12"
