...
export default function ContactCta() {
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-architect-navy text-white">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <ScrollReveal animation="fade-bottom">
          ...
          <Button asChild size="lg" className="bg-architect-vibrant hover:bg-architect-vibrant/90 text-white">
