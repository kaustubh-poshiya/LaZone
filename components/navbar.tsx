...
export default function Navbar() {
  ...
  const hasLightBackground = ['/contact', '/about', '/services', '/portfolio', '/services/interior-design', '/services/architecture', '/services/project-management', '/services/furnishing-fitout', '/services/lifestyle-wellbeing', '/services/3d-rendering'].includes(pathname)
  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? "bg-background/95 backdrop-blur-xl shadow-lg border-b border-border/50 py-2" : "bg-transparent py-5",
      )}
    >
        ...
        <Link href="/" className="relative z-10">
          <div className="flex items-center">
            <Image
              ...
              height={100}
              priority
              className="h-16 w-auto transition-transform duration-300 ease-in-out"
